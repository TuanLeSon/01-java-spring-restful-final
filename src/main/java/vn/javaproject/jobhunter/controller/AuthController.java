...
import vn.javaproject.jobhunter.domain.request.ReqLoginDTO;
import vn.javaproject.jobhunter.domain.response.ResCreateUserDTO;
import vn.javaproject.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDTO) {// de void de ko muon truyen vao
                                                                                        // body
